...
class Exporter:
    ...
    def export_yolo(self, annotations: Dict[str, List[Dict]], 
                    image_sizes: Dict[str, Tuple[int, int]], class_names: List[str]) -> str:
        """
        ...
        for filename, dets in annotations.items():
            ...
            # Use 1x1 if size is 0 to avoid division by zero
            if width <= 0: width = 1
        ...
        with open(csv_path, 'w', newline='') as f:
            ...
            for filename, dets in annotations.items():
                for det in dets:
                    ...
                    writer.writerow([
                        filename, det['class'], det.get('confidence', 1.0), shape,
